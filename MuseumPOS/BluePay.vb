...
Namespace BPVB
    ...
    Public Class BluePay
        ...
        ''' 
        Public Sub saleTransactionID(ByVal amount As String, ByVal transactionID As String)
            Me.transType = "SALE"
            Me.amount = amount
        ...
        ''' 
        Public Sub saleCustomerToken(ByVal amount As String, ByVal customerToken As String)
            Me.transType = "SALE"
            Me.amount = amount
        ...
        ''' <param name="masterID"></param>
        ''' 
        Public Sub authTransactionID(ByVal amount As String, ByVal transactionID As String)
            Me.transType = "AUTH"
            Me.amount = amount
            Me.masterID = transactionID
            Me.api = "bp10emu"
        ...
        ''' 
        Public Sub authCustomerToken(ByVal amount As String, ByVal newCustomerToken As String)
            Me.transType = "AUTH"
            Me.amount = amount
